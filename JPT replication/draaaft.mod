...
stoch_simul(irf=60, irf_shocks=(eps_z,eps_mp,eps_mu), contemporaneous_correlation);
...
estimation(datafile='model_data.mat', prior_trunc=0, mode_compute=5, mh_replic=120000, mh_jscale=0.56, mode_file='draaaft_mode.mat');